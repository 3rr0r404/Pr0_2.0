...
(function() {
    ...
    var highitemimage = $(window).height()-163;
    ...
    var css = '#upload-form input[type="submit"] { position:relative; top: 420px; left: 350px; }'+
        ...
        '.comments { padding: 0 8px 0 8px !important;}'+	
        '.comment-foot { border-bottom: 0px !important}'+
        ...
        'div.comment { background: rgba(26, 27, 30, 0.7); border-radius: 2px; border-bottom: 1px solid #252525 !important;}'+
        ...
        'div.item-details { height: 37px; padding: 4px 0 8px 0px !important;}'+
        '#head-menu { left: 200px; position: absolute;}'+
        'div.in-pane { margin-left: -5px}'+
        
        '#filter-menu { left: 318px !important;}'+
        '#footer-links { top: 17px; left: auto !important; right: 270px !important; height: 20px; width:100px !important; bottom: 0px !important; margin: 0 !important}'+
        '#footer-links a { color: rgb(238, 77, 46);}'+
        '#footer-links div:nth-child(2n) a { display: none;}'+
